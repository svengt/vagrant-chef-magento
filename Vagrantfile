...
$server_root_password = "sadvWQEFasdv3!"
$server_user_password = "156fsdgEWER%!"
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision :shell, :inline => "mysql -u root -p#{$server_root_password} -e \"GRANT ALL ON dev_db.* TO 'dev_user'@'localhost' IDENTIFIED BY '#{$server_user_password}'; FLUSH PRIVILEGES;\""
